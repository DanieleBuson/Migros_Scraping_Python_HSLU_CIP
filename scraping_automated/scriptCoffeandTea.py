...
url = 'https://www.migros.ch/en/category/drinks-coffee-tea'
                ...
                if tempString.startswith(brand):
                    ...
                    for char in tempString:
                        if char.isdigit() and count_digit==0:
                            ...
                            ToF.append("Coffe, Drinks and Tea")
...
coffeDf = pd.DataFrame(total_list).transpose()
coffeDf.columns = ["Price", "Product", "Producer", "Quantity", "Type of food", "Supermarket", "Date"]
## Here it is the result in a tabular form.
print(coffeDf)

with open('data/coffe_drinks_tea.txt', 'w') as csv_file:
    coffeDf.to_csv(path_or_buf=csv_file)
