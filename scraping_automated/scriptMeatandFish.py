...
url = 'https://www.migros.ch/en/category/meat-fish'
...
meatDF = pd.DataFrame(total_list).transpose()
meatDF.columns = ["Price", "Product", "Producer", "Quantity", "Type of food", "Supermarket", "Date"]
## Here it is the result in a tabular form.
print(meatDF)

with open('data/fish_and_meat.txt', 'w') as csv_file:
    meatDF.to_csv(path_or_buf=csv_file)