...
url = 'https://www.migros.ch/en/category/dairy-eggs-fresh-convenience-foo'
                ...
                if tempString.startswith(brand):
                    ...
                    for char in tempString:
                        if char.isdigit() and count_digit==0:
                            ...
                            ToF.append("Dairy, Eggs & Fresh Convenience Food")
...
dairyDf = pd.DataFrame(total_list).transpose()
dairyDf.columns = ["Price", "Product", "Producer", "Quantity", "Type of food", "Supermarket", "Date"]
