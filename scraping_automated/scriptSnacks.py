...
url = 'https://www.migros.ch/en/category/snacks-sweets'
...
snackDF = pd.DataFrame(total_list).transpose()
snackDF.columns = ["Price", "Product", "Producer", "Quantity", "Type of food", "Supermarket", "Date"]
## Here it is the result in a tabular form.
print(snackDF)

with open('data/snacks_and_sweets.txt', 'w') as csv_file:
    snackDF.to_csv(path_or_buf=csv_file)
