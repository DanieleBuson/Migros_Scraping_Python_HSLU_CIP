...
url = 'https://www.migros.ch/en/category/frozen-food'
...
frozenDf = pd.DataFrame(total_list).transpose()
frozenDf.columns = ["Price", "Product", "Producer", "Quantity", "Type of food", "Supermarket", "Date"]
